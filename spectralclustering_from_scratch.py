...
class SpectralClustering:
    ...
    def fit(self, data):
        ...
        if self.assign_labels == 'kmeans':
            #avoiding errors like (5 + 0*j) complex numbers using .real comp.
            kmeans = KMeans(n_clusters=self.n_cluster, init="k-means++").fit(t.real)
            self.labels_ = kmeans.labels_

        #cluster_qr from https://arxiv.org/pdf/1609.08251.pdf
